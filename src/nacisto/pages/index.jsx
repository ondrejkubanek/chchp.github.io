    ...
    <section id="restaurace">
        <div className="banner restaurace-image w-100 vh-100 d-flex align-items-center">
            <div className="container restaurace">
                ...
                <h2 className="restaurace-text text-white">NETRADIČNÁ STYLOVÁ RESTAURACE S&nbsp;MINIPIVOVAREM
                    V&nbsp;PŮVODNÍM
                    CHMELOVÉM SKLADU</h2>
            ...
            <div className="col-sm-12 col-lg-6 col-xl-4 mt-5">
                <div className="interests">
                    ...
                    <div className="interest-body">
                        ...
                        <p className="interest-text">Žatec jako kandidát na seznam UNESCO? Ano! A to i s krajinou našeho
                            jedinečného
                            žateckého chmele. </p>
                    </div>
                </div>
            ...
            <div className="col-sm-12 col-lg-6 col-xl-4 mt-5">
                <div className="interests">
                    ...
                    <div className="interest-body">
                        ...
                        <p className="interest-text">Víte, že je Žatec oblíbeným místem filmařů? V&nbsp;Galerii Sladovna
                            o tom máme
            ...
            <div className="col-sm-12 col-lg-6 col-xl-4 mt-5">
                <div className="interests">
                    ...
                    <div className="interest-body">
                        ...
                        <p className="interest-text">Žatec je stokomínové město! Po bývalých sušárnách chmele nebo
                            sirným komorách
            ...
            <div className="col-sm-12 col-lg-6 col-xl-4 mt-5">
                <div className="interests">
                    ...
                    <div className="interest-body">
                        ...
                        <p className="interest-text">Kolikrát jste šli přes žatecké hlavní náměstí Svobody, aniž byste
                            si všimli
            ...
            <div className="col-sm-12 col-lg-6 col-xl-4 mt-5">
                <div className="interests">
                    ...
                    <div className="interest-body">
                        ...
                        <p className="interest-text">V Žatecké chmelařské oblasti se pěstuje světově nejkvalitnější
                            odrůda chmele.
                            Proč se&nbsp;červeňáku daří jen v naší oblasti? To se dozvíte v naší prohlídce v Chrámu
                            Chmele
                            a&nbsp;Piva…</p>
                    </div>
                </div>
            ...
            <div className="col-sm-12 col-lg-6 col-xl-4 mt-5">
                <div className="interests">
                    ...
                    <div className="interest-body">
                        ...
                        <p className="interest-text">Kdo byli Homolupulové? Odhalte historii dávných obyvatelů žatecké
                            chmelařské
    ...
    <section id="galerie" className="container">
        ...
        <div className="row my-5">
            ...
            <div className="col-lg-4 events-title">
                ...
                z&nbsp;nich na fotografiích: Dočesná, zahájení žatecké turistické sezóny, koncerty, vernisáže výstav,
                zajímavé
